  ...
  return (
    <div className="border-b border-[#e7e9ee] bg-[#f7f8fa] text-[#606875]">
      <div className="mx-auto flex h-9 w-full max-w-[1720px] items-center justify-between gap-3 px-4 sm:px-6">
        ...
        <div className="hidden min-w-0 max-w-[260px] items-center gap-2 text-[11px] sm:flex"><span className="text-[#9aa1ab]">Project</span><span className="truncate font-medium text-[#303640]">{activeProjectTitle || (activeProjectId ? "Active project" : "Local workspace")}</span></div>
      </div>
    </div>
  );
}
